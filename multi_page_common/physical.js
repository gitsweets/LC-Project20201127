...
let projectConfig = {
	...
	// 开发环境指定的静态文件
	devTemplate: 'component/orderInfo/orderInfo.html',
	// 生产环境指定生成的名字
...
commonConfig.multiPage = [
	{
		...
		name: "drugInfo",
		path: 'drugInfo/',
		chunks	: ['manifest', 'drugInfo'],
		dev : {
			// 开发环境指定生成的名字
			filename: 'index.html',
			// 开发环境指定的静态文件
			template: commonConfig.devPath + 'component/drugInfo/drugInfo.html',
		},
		build : {
			// 生产环境指定生成的名字
			filename: commonConfig.relativePath + 'html/mobile_iphone/otc_detail_pe.php',
			// 生产环境指定的静态文件
			template: commonConfig.devPath + 'component/drugInfo/drugInfo_build.html',
		}
	},
	{
		title: "订单支付",
		name: "orderDetails",
		path: 'orderDetails/',
		chunks	: ['manifest', 'orderDetails'],
		dev : {
			// 开发环境指定生成的名字
			filename: 'orderDetails.html',
			// 开发环境指定的静态文件
			template: commonConfig.devPath + 'component/orderDetails/orderDetails.html',
		},
		build : {
			// 生产环境指定生成的名字
			filename: commonConfig.relativePath + 'html/mobile_iphone/orderform_pe.php',
			// 生产环境指定的静态文件
			template: commonConfig.devPath + 'component/orderDetails/orderDetails_build.html',
		}
	},
	{
		title: "订单详情",
		name: "orderInfo",
		path: 'orderInfo/',
		chunks	: ['manifest', 'orderInfo'],
		dev : {
			// 开发环境指定生成的名字
			filename: 'orderInfo.html',
			// 开发环境指定的静态文件
			template: commonConfig.devPath + 'component/orderInfo/orderInfo.html',
		},
		build : {
			// 生产环境指定生成的名字
			filename: commonConfig.relativePath + 'html/mobile_iphone/orderform_pe_detail.php',
			// 生产环境指定的静态文件
			template: commonConfig.devPath + 'component/orderInfo/orderInfo_build.html',
		}
	},
	{
		title: "订单详情_检查检验",
		name: "orderInfo_Inspection",
		path: 'orderInfo_Inspection/',
		chunks	: ['manifest', 'orderInfo_Inspection'],
		dev : {
			// 开发环境指定生成的名字
			filename: 'orderInfo_Inspection.html',
			// 开发环境指定的静态文件
			template: commonConfig.devPath + 'component/orderInfo_Inspection/orderInfo_Inspection.html',
		},
		build : {
			// 生产环境指定生成的名字
			filename: commonConfig.relativePath + 'html/mobile_iphone/orderform_child_care_detail.php',
			// 生产环境指定的静态文件
			template: commonConfig.devPath + 'component/orderInfo_Inspection/orderInfo_Inspection_build.html',
		}
	},
];
