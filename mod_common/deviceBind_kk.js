...
let projectConfig = {
	...
	// 开发环境指定的静态文件
	devTemplate: 'component/deviceBind_kk/deviceBind_kk.html',
	// 生产环境指定生成的名字
	buildFilename: 'html/mobile_iphone/kangkangbloodpressuremonitor-index.php',
	// 开发环境指定的静态文件
	buildTemplate: 'component/deviceBind_kk/deviceBind_kk_build.html',
};
