...
let projectConfig = {
	...
	// 开发环境指定的静态文件
	devTemplate: 'component/orderDetails/orderDetails.html',
	// 生产环境指定生成的名字
	buildFilename: 'html/mobile_iphone/orderform_pe.php',
	// 开发环境指定的静态文件
	buildTemplate: 'component/orderDetails/orderDetails_build.html',
};
