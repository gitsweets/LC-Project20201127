...
let projectConfig = {
	...
	// 开发环境指定的静态文件
	devTemplate: 'component/customs_simp/customs_simp.html',
	// 生产环境指定生成的名字
	buildFilename: 'html/mobile_iphone/lancarecustomhouseinterfaceTianjin-no-charge-service-page.php',
	// 开发环境指定的静态文件
	buildTemplate: 'component/customs_simp/customs_simp_build.html',
};
