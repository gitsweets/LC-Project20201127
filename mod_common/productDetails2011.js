...
let projectConfig = {
	// 项目指向路径和生成增加路径
	path: 'productDetails2011/',
	// 开发环境指定生成的名字
	devFilename: 'index.html',
	// 开发环境指定的静态文件
	devTemplate: 'views/productDetails2011/productDetails2011.html',
	// 生产环境指定生成的名字
	buildFilename: 'html/mobile_iphone/goods_activityinfo.php',
	// 开发环境指定的静态文件
	buildTemplate: 'views/productDetails2011/productDetails2011_build.html',
};
...
commonConfig.entry = {
	...
	// 业务
	page: commonConfig.devPath + 'views/' + projectConfig.path + 'index.js'
};
	...
	commonConfig.cdn = {
		dev : {
			...
			options: {
				...
				swipe : '//img.lancare.cc/themes/simplicity/js/swipe.min.js',
				// mobiscroll: '//img.lancare.cc/themes/simplicity/js/mobiscroll.custom-3.0.0-beta2.min.js',
				// mobiscrollCss: '//img.lancare.cc/themes/simplicity/css/mobiscroll_selfstyle.css',
			}
		},
		build : {
			isWork : true,
			options: {
				...
				jquery: '//img.lancare.cc/themes/simplicity/js/jquery-1.10.2.min.js',
				swipe : '//img.lancare.cc/themes/simplicity/js/swipe.min.js',
				// jquery: commonConfig.buildPublicPath + '/themes/simplicity/js/jquery-1.10.2.min.js',
				// mobiscroll: commonConfig.buildPublicPath + '/themes/simplicity/js/mobiscroll.custom-3.0.0-beta2.min.js',
				// mobiscrollCss: commonConfig.buildPublicPath + '/themes/simplicity/css/mobiscroll_selfstyle.css',
			}
		}
	},
