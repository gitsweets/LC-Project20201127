...
let projectConfig = {
	// 项目指向路径和生成增加路径
	path: 'orderDetails_adult/',
	// 开发环境指定生成的名字
	devFilename: 'index.html',
	// 开发环境指定的静态文件
	devTemplate: 'component/orderDetails_adult/orderDetails.html',
	// 生产环境指定生成的名字
	buildFilename: 'html/mobile_iphone/orderform_adult.php',
	// 开发环境指定的静态文件
	buildTemplate: 'component/orderDetails_adult/orderDetails_build.html',
};
