...
let projectConfig = {
	// 项目指向路径和生成增加路径
	path: 'InternetPharmacy/',
	// 开发环境指定生成的名字
	devFilename: 'index.html',
	// 开发环境指定的静态文件
	devTemplate: 'views/InternetPharmacy/InternetPharmacy.html',
	// 生产环境指定生成的名字
	buildFilename: 'html/mobile_iphone/otc_znyfs-drug-malls-f.php',
	// 开发环境指定的静态文件
	buildTemplate: 'views/InternetPharmacy/InternetPharmacy_build.html',
};
